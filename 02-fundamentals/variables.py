...
print("Identita proměnné 'students_count':", id(students_count))
print("Identita proměnné 'rating':", id(rating))
print("Identita proměnné 'is_published':", id(is_published))
...
HexDec = str(0x1a)
binHexDec = int(bin(int(HexDec, 16))[2:])

myself_binary = str(0b10101101)
myself_decimal = int(myself_binary, 2)

'''Je potreba opravit'''


vysledek = myself_binary & binHexDec

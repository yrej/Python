...
# V jazyce Python se slovníky zapisují pomocí složených závorek a mají klíče a hodnoty.
car = {
  'brand': 'Ford',
  'model': 'Mustang',
  'year': 1964
...
# c)
print("+------------------------------------------------------------------------------------------------------------+")
print("|{:<35} {:<25} {:<10} {:<15} {:<10} {:<8}|".format('Název', 'Autor', 'Rok', 'Žánr', 'Hodnocení', 'Přečteno'))
print("+------------------------------------------------------------------------------------------------------------+")
for book in knihy:
    print("|{:<35} {:<25} {:<10} {:<17} {:<12} {:<4}|".format(book['nazev'], book['autor'], book['rok'], book['zanr'], book['hodnoceni'], book['precteno']))
print("+------------------------------------------------------------------------------------------------------------+")
...
x = 0
#global = 1    klíčové slovo jako název promene
globalni = 1

PI = 3.14
city = "Opava"

#hilda@sspu-opava.cz = 'Hilda Dokonalá'  pouziti jinych nez alfanumerickych znaku jako nazev promene
hilda_sspu_opava_cz = 'Hilda Dokonala'

password2 = 'TajneHeslo'
#007agent = 'James Bond'   promena nemuze zacinat cisly
nula07agent = 'James Bond'
